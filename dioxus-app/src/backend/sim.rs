...
use crate::backend::analyze::{PtAnalyzer, SemanticNetDto, build_cvn, build_pt, build_timed};
...
pub fn sim_initial(semantic: &SemanticNetDto) -> Result<SimResultDto, String> {
...
mod tests {
    use super::*;
    use crate::backend::analyze::{ArcDataDto, IntervalDto, SemanticArcDto, SemanticPlaceDto, SemanticTransitionDto, TransitionDataDto};

    fn place(id: &str, label: &str, tokens: usize) -> SemanticPlaceDto {
        SemanticPlaceDto {
            id: id.into(),
            data: crate::backend::analyze::PlaceDataDto {
                label: label.into(),
                tokens,
                capacity: None,
                capacity_mode: None,
